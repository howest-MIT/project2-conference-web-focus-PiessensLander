                ...
                <div class="c-login p-4">
                    ...
                    <div>
                        <form action="register-validate.php" method="POST" class="d-flex flex-column c-login__form">
                            ...
                            <input type="text" name="first_name" id="first_name" class="c-form__input c-form__input--text mb-3" placeholder="First name" required>
                            <input type="text" name="last_name" id="last_name" class="c-form__input c-form__input--text mb-3" placeholder="Last name" required>
                            <input type="password" name="password" id="password" class="c-form__input c-form__input--text mb-3" placeholder="Password" required>
                            <button type="submit" name="submit" id="submit" value="submit" class="c-btn c-btn--pink py-2 px-5 text-center">Sign up</button>
                        </form>
                    </div>
                </div>
            </div>
